    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black transition-colors flex flex-col">
      ...
      <main className="flex-1 max-w-lg mx-auto w-full px-4 py-6 space-y-6 pb-24">
        ...
        <motion.button
          ...
          animate="visible"
          onClick={openService}
          className="w-full py-4 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl font-medium flex items-center justify-center gap-2 transition-colors"
        >
        ...
        >
          <h2 className="text-lg font-semibold text-black dark:text-white mb-4">
            {t.photos.serviceInfo}
          </h2>

          <div className="space-y-3">
            <InfoRow label={t.photos.homeNetwork} value={serviceConfig.homeNetwork} onCopy={copyToClipboard} />
            <InfoRow label={t.photos.tailscaleNetwork} value={serviceConfig.tailscaleNetwork} onCopy={copyToClipboard} />
            <InfoRow label={t.photos.publicNetwork} value={serviceConfig.publicNetwork} onCopy={copyToClipboard} />
            <div className="border-t border-black/5 dark:border-white/10 my-3" />
            <InfoRow label={t.photos.account} value={serviceConfig.account} onCopy={copyToClipboard} />
            <InfoRow label={t.photos.password} value={serviceConfig.password} onCopy={copyToClipboard} />
          </div>
        </motion.div>
      </main>
